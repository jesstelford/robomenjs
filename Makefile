...
$(DISTDIR)/bundle.js: $(LIB)
	@mkdir -p "$(@D)"
	$(CJSIFY) -x $(MAINMODULE) $(CJSIFYEXTRAPARAMS) -a "underscore.js":"../node_modules/underscore/underscore.js" -a "animationFrame.js":"../node_modules/animationFrame/AnimationFrame.js" -a "q.js":"../node_modules/q/q.js" $(shell node -pe 'require("./package.json").main') >"$@"
